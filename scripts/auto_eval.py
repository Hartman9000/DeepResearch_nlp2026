...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--eval-workers", type=int, default=4, help="Parallel workers for LLM judging.")
...
def main() -> None:
    ...
    submission_path = output_dir / "research_agent_hard50_submission.jsonl"
    eval_path = output_dir / "research_agent_hard50_eval.jsonl"
    summary_path = output_dir / "research_agent_hard50_summary.json"
